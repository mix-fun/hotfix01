  ...
  return {
    ...
    execute: function () {
      ...
      */
      ...
      let BoxControl = exports('BoxControl', (_dec = ccclass('box_control'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(Node), _dec7 = property(Node), _dec(_class = (_class2 = class BoxControl extends Component {
        constructor(...args) {
          super(...args);
          _initializerDefineProperty(this, "imageNormal", _descriptor, this);
          _initializerDefineProperty(this, "aniIdleWrapNode", _descriptor2, this);
          _initializerDefineProperty(this, "aniJumpNode", _descriptor3, this);
          _initializerDefineProperty(this, "aniReachNode", _descriptor4, this);
          _initializerDefineProperty(this, "aniUnQuestWrapNode", _descriptor5, this);
        ...
        update(deltaTime) {}
        reset() {
          this.aniIdleWrapNode.active = false;
          // this.imageNormal.active = false;
          this.aniJumpNode.active = false;
          this.aniReachNode.active = false;
        ...
        doAniJumping() {
          // 只在copy的boxNode上播放
          const key = this._boxKey;
          this.aniJumpNode.active = true;
          this.aniIdleWrapNode.active = false;
          // this.imageNormal.active = false;
          this.aniReachNode.active = false;
          this.aniUnQuestWrapNode.active = false;
          this.icon.active = true;
          let light = this.aniJumpNode.getChildByName("light");
          light.getComponent(Sprite).spriteFrame = ResManager.instance.getBlockSprite(`block_${key}_light`);
        }
        doAniLanding() {
          // 只在copy的boxNode上播放
      ...
      }), _descriptor2 = _applyDecoratedDescriptor(_class2.prototype, "aniIdleWrapNode", [_dec3], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
      ...
      }), _descriptor3 = _applyDecoratedDescriptor(_class2.prototype, "aniJumpNode", [_dec4], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
      ...
      }), _descriptor4 = _applyDecoratedDescriptor(_class2.prototype, "aniReachNode", [_dec5], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
      ...
      }), _descriptor5 = _applyDecoratedDescriptor(_class2.prototype, "aniUnQuestWrapNode", [_dec6], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
  ...
  return {
    ...
    execute: function () {
      ...
      class ResManager {
        ...
        async preloadAtlas() {
          const atlases = [ResAtlasName.ATLAS_BLOCK];
          const promises = [];
...
System.register("chunks:///_virtual/stage.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './game-desk.ts', './stage-helper.ts', './ui-manager.ts', './ui-config.ts', './audio-manager.ts', './game-constants.ts', './game-data-manager.ts', './report-agent.ts', './mount-manager.ts', './mount-point.ts'], function (exports) {
  var _applyDecoratedDescriptor, _initializerDefineProperty, cclegacy, Node, Label, Sprite, SpriteFrame, _decorator, Component, director, UIOpacity, sp, Color, tween, GameDesk, StageEvent, UIManager, UICF, UIID, AudioManager, GameEvent, AudioUrl, GameDataManager, ReportAgent, CustomReportEvent, LoadingActionParam, MountManager, MountPoint;
  return {
    setters: [function (module) {
      _applyDecoratedDescriptor = module.applyDecoratedDescriptor;
      _initializerDefineProperty = module.initializerDefineProperty;
    ...
    execute: function () {
      ...
      let Stage = exports('Stage', (_dec = ccclass('stage'), _dec2 = property(Node), _dec3 = property(GameDesk), _dec4 = property(Node), _dec5 = property(Label), _dec6 = property(Node), _dec7 = property(Sprite), _dec8 = property([SpriteFrame]), _dec(_class = (_class2 = class Stage extends Component {
        constructor(...args) {
          super(...args);
          ...
          _initializerDefineProperty(this, "bgFrames", _descriptor7, this);
        }
        onLoad() {
        ...
        animateLevelEnter(stageTyep) {
          ...
          switch (stageTyep) {
            ...
            case 'boss':
              ...
              this.bgSpr.spriteFrame = this.bgFrames[2];
      ...
      }), _descriptor7 = _applyDecoratedDescriptor(_class2.prototype, "bgFrames", [_dec8], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
