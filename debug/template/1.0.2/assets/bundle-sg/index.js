System.register("chunks:///_virtual/ad-unlock-popup.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ad-manager.ts', './ui-manager.ts', './ui-view.ts', './ui-config.ts', './game-data-manager.ts', './reward-manager.ts', './report-agent.ts', './audio-manager.ts', './game-constants.ts', './bridge-util.ts'], function (exports) {
  var _applyDecoratedDescriptor, _initializerDefineProperty, cclegacy, Label, _decorator, director, AdManager, UIManager, UIView, UIID, GameDataManager, RewardManager, ReportAgent, CustomReportEvent, PageName, BtnName, PhotoChooseNumReportEvent, AudioManager, AudioUrl, BridgeUtil, VibrationEffect;
  return {
    ...
    execute: function () {
      ...
      let AdUnlockPopup = exports('AdUnlockPopup', (_dec = ccclass('AdUnlockPopup'), _dec2 = property(Label), _dec(_class = (_class2 = class AdUnlockPopup extends UIView {
        ...
        onOpen(fromUI, ...args) {
          ...
          let price = RewardManager.instance.getConfig().sg.illustration_cost;
        ...
        async onCloseBtn() {
          ...
          GameDataManager.instance.data.firstGameAction.select_pic_guide = false;
          UIManager.instance.close(this);
          if (!this.isCloseDirectly) {
            RewardManager.instance.openPictureSelectView();
          }
          let isOpenInter = false;
          let config = RewardManager.instance.getConfig();
          console.log(`config: ${config}`);
          if (config) {
            let info = config.ad.inter.page.enough_coins;
          ...
          if (isOpenInter) {
            AdManager.instance.openInterstitialAd('enough_coins', null);
          }
        }
        onUnlockBtn() {
          this.onClickBtn();
...
System.register("chunks:///_virtual/album-detail-view.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ui-view.ts', './picture-item.ts', './ui-manager.ts', './audio-manager.ts', './game-constants.ts', './bridge-util.ts', './game-data-manager.ts', './sg-manager.ts', './report-agent.ts'], function (exports) {
  var _applyDecoratedDescriptor, _initializerDefineProperty, cclegacy, Prefab, Sprite, Label, ProgressBar, Node, _decorator, instantiate, director, UIView, PictureItem, UIManager, AudioManager, AudioUrl, BridgeUtil, VibrationEffect, GameDataManager, SgManager, ReportAgent, CustomReportEvent;
  return {
    setters: [function (module) {
      _applyDecoratedDescriptor = module.applyDecoratedDescriptor;
      _initializerDefineProperty = module.initializerDefineProperty;
    ...
    execute: function () {
      ...
      cclegacy._RF.push({}, "ab333SWT1FDhpywzIvNu+6T", "album-detail-view", undefined);
      const {
        ccclass,
        property
      } = _decorator;
      let AlbumDetailView = exports('AlbumDetailView', (_dec = ccclass('AlbumDetailView'), _dec2 = property(Prefab), _dec3 = property(Sprite), _dec4 = property(Label), _dec5 = property(Label), _dec6 = property(Label), _dec7 = property(ProgressBar), _dec8 = property(Node), _dec9 = property(Node), _dec10 = property(Label), _dec(_class = (_class2 = class AlbumDetailView extends UIView {
        constructor(...args) {
          super(...args);
          _initializerDefineProperty(this, "prfbItem", _descriptor, this);
          _initializerDefineProperty(this, "sprCover", _descriptor2, this);
          _initializerDefineProperty(this, "lblName", _descriptor3, this);
          _initializerDefineProperty(this, "lblOccupation", _descriptor4, this);
          _initializerDefineProperty(this, "lblDesc", _descriptor5, this);
          _initializerDefineProperty(this, "progressBar", _descriptor6, this);
          _initializerDefineProperty(this, "container", _descriptor7, this);
          _initializerDefineProperty(this, "coverLock", _descriptor8, this);
          _initializerDefineProperty(this, "lblCost", _descriptor9, this);
          this.info = null;
          this.items = [];
        }
        onOpen(fromUI, ...args) {
          ...
          this.info = args[0];
          this.lblName.string = this.info.name;
          this.lblOccupation.string = this.info.occupation;
          this.lblDesc.string = this.info.desc;
          this.lblCost.string = this.info.cost.toString();
          let sgMgr = SgManager.instance;
          for (let i = 0; i < this.info.pictures.length; i++) {
            let picInfo = this.info.pictures[i];
            let picData = GameDataManager.instance.getPictureData(picInfo.id, this.info.id);
            let node = instantiate(this.prfbItem);
            let item = node.getComponent(PictureItem);
            if (item) {
              item.initWithInfo(picInfo, this.info.id);
              this.items.push(item);
              this.container.addChild(node);
            }
          }
          let data = GameDataManager.instance.sg.album[this.info.id];
          if (!data) {
            this.collectCount = 0;
            this.coverLock.active = true;
          } else {
            this.collectCount = Object.keys(data.pictures).length;
            this.coverLock.active = false;
          }
        }
        onTop(preID, ...args) {
          this.showAccountLayout();
        ...
        set collectCount(val) {
          this.progressBar.progress = val / this.info.pictures.length;
          let lbl = this.progressBar.getComponentInChildren(Label);
          lbl.string = `${val}/${this.info.pictures.length}`;
        }
        showAccountLayout() {
          let accountLayout = director.getScene().getChildByPath('Canvas/midLayer/LayoutTokenAccount');
          if (accountLayout) {
        ...
        onUnlockBtn() {
          ...
          if (gdMgr.getFragment() < this.info.cost) {
            UIManager.instance.showToast('Not enough fragments');
          } else {
            gdMgr.addFragment(-this.info.cost);
            gdMgr.AddAlbumData(this.info.id);
            this.coverLock.active = false;
            if (GameDataManager.instance.data.firstGameAction.album_unlock) {
              GameDataManager.instance.data.firstGameAction.album_unlock = false;
      ...
      }, (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "prfbItem", [_dec2], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
      ...
      }), _descriptor2 = _applyDecoratedDescriptor(_class2.prototype, "sprCover", [_dec3], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
      ...
      }), _descriptor4 = _applyDecoratedDescriptor(_class2.prototype, "lblOccupation", [_dec5], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
      ...
      }), _descriptor8 = _applyDecoratedDescriptor(_class2.prototype, "coverLock", [_dec9], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
      ...
      }), _descriptor9 = _applyDecoratedDescriptor(_class2.prototype, "lblCost", [_dec10], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
...
System.register("chunks:///_virtual/album-item.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ui-manager.ts', './ui-config.ts', './audio-manager.ts', './game-constants.ts', './bridge-util.ts', './game-data-manager.ts'], function (exports) {
  var _applyDecoratedDescriptor, _initializerDefineProperty, cclegacy, ProgressBar, Sprite, Label, Node, _decorator, Component, UIManager, UIID, AudioManager, AudioUrl, BridgeUtil, VibrationEffect, GameDataManager;
  return {
    setters: [function (module) {
      _applyDecoratedDescriptor = module.applyDecoratedDescriptor;
      _initializerDefineProperty = module.initializerDefineProperty;
    ...
    execute: function () {
      ...
      cclegacy._RF.push({}, "6e33ahOlUtGVqjSxb+qL6vg", "album-item", undefined);
      const {
        ccclass,
        property
      } = _decorator;
      let AlbumItem = exports('AlbumItem', (_dec = ccclass('AlbumItem'), _dec2 = property(ProgressBar), _dec3 = property(Sprite), _dec4 = property(Label), _dec5 = property(Node), _dec6 = property(Node), _dec(_class = (_class2 = class AlbumItem extends Component {
        constructor(...args) {
          super(...args);
          _initializerDefineProperty(this, "progressBar", _descriptor, this);
          _initializerDefineProperty(this, "picture", _descriptor2, this);
          _initializerDefineProperty(this, "lblCount", _descriptor3, this);
          _initializerDefineProperty(this, "coverLock", _descriptor4, this);
          _initializerDefineProperty(this, "iconComplete", _descriptor5, this);
          this.info = null;
        }
        initWithInfo(info) {
          this.info = info;
          this.lblCount.string = `${info.pictures.length}`;
          let coverInfo = info.pictures[0];
          if (coverInfo) ;else {
            console.error(`AlbumItem initWithInfo: picInfo is null`);
          }
          this.updateUI();
        }
        updateUI() {
          let albumData = GameDataManager.instance.sg.album[this.info.id];
          if (!albumData) {
            this.isLock = true;
            this.collectCount = 0;
          } else {
            this.isLock = false;
            this.collectCount = Object.keys(albumData.pictures).length;
          }
        }
        set isLock(val) {
          this.coverLock.active = val;
          this.progressBar.node.active = !val;
        }
        get isLock() {
          return this.coverLock.active;
        }
        set collectCount(val) {
          if (val < this.info.pictures.length) {
            this.progressBar.node.active = true;
            this.progressBar.progress = val / this.info.pictures.length;
            let lbl = this.progressBar.getComponentInChildren(Label);
            lbl.string = `${val}/${this.info.pictures.length}`;
            this.lblCount.node.parent.active = true;
            this.iconComplete.active = false;
          } else {
            this.progressBar.node.active = false;
            this.lblCount.node.parent.active = false;
            this.iconComplete.active = true;
          }
        }
        onClickItem() {
          AudioManager.instance.playEffect(AudioUrl.BTN_CLICK);
          BridgeUtil.vibrate(30, VibrationEffect.TICK);
          UIManager.instance.open(UIID.AlbumDetailView, this.info);
        }
      ...
      }), _descriptor2 = _applyDecoratedDescriptor(_class2.prototype, "picture", [_dec3], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
      ...
      }), _descriptor3 = _applyDecoratedDescriptor(_class2.prototype, "lblCount", [_dec4], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
      ...
      }), _descriptor4 = _applyDecoratedDescriptor(_class2.prototype, "coverLock", [_dec5], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
      ...
      }), _descriptor5 = _applyDecoratedDescriptor(_class2.prototype, "iconComplete", [_dec6], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
...
System.register("chunks:///_virtual/album-view.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './bridge-util.ts', './audio-manager.ts', './ui-manager.ts', './ui-view.ts', './game-constants.ts', './album-item.ts', './game-data-manager.ts', './sg-manager.ts', './report-agent.ts'], function (exports) {
  var _applyDecoratedDescriptor, _initializerDefineProperty, cclegacy, Node, Prefab, Sprite, _decorator, instantiate, director, BridgeUtil, VibrationEffect, AudioManager, UIManager, UIView, AudioUrl, AlbumItem, GameDataManager, SgManager, ReportAgent, CustomReportEvent;
  return {
    setters: [function (module) {
      _applyDecoratedDescriptor = module.applyDecoratedDescriptor;
      _initializerDefineProperty = module.initializerDefineProperty;
    ...
    execute: function () {
      ...
      cclegacy._RF.push({}, "af95d7jeOtOfJErHP7jfr3q", "album-view", undefined);
      const {
        ccclass,
        property
      } = _decorator;
      let AlbumView = exports('AlbumView', (_dec = ccclass('AlbumView'), _dec2 = property(Node), _dec3 = property(Prefab), _dec4 = property(Sprite), _dec(_class = (_class2 = class AlbumView extends UIView {
        constructor(...args) {
          super(...args);
          _initializerDefineProperty(this, "container", _descriptor, this);
          _initializerDefineProperty(this, "itemPrefab", _descriptor2, this);
          _initializerDefineProperty(this, "sprCover", _descriptor3, this);
          this.items = [];
        }
        onOpen(fromUI, ...args) {
          this.hideAccountLayout();
          if (GameDataManager.instance.data.firstGameAction.album_view) {
            GameDataManager.instance.data.firstGameAction.album_view = false;
            ReportAgent.reportCustomEvent(CustomReportEvent.USER_LIFECYCLE_MILESTONE, {
              action: 'album_show'
            });
          }
          let config = SgManager.instance.sgPicInfo.album;
          for (let i = 0; i < config.length; i++) {
            let node = instantiate(this.itemPrefab);
            let item = node.getComponent(AlbumItem);
            let info = config[i];
            if (item) {
              item.initWithInfo(info);
              this.items.push(item.getComponent(AlbumItem));
      ...
      }), _descriptor3 = _applyDecoratedDescriptor(_class2.prototype, "sprCover", [_dec4], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
...
System.register("chunks:///_virtual/bundle-sg", ['./sg-manager.ts', './sg-text-config.ts', './sg-type-define.ts', './ad-unlock-popup.ts', './album-detail-view.ts', './album-item.ts', './album-view.ts', './btn-toggle.ts', './bubble-tips.ts', './description-view.ts', './enable-btn.ts', './illustration-tab.ts', './illustration-view.ts', './loading-sg-view.ts', './paused-popup-sg.ts', './picture-bubble.ts', './picture-item.ts', './picture-obtain-popup.ts', './picture-select-item.ts', './picture-select-view.ts', './sign-in-popup-sg.ts', './slide-picture-view.ts', './special-reward-popup.ts', './start-view-sg.ts', './task-item.ts'], function () {
  return {
...
System.register("chunks:///_virtual/description-view.ts", ['cc', './ui-manager.ts', './ui-view.ts', './ui-config.ts', './game-data-manager.ts', './sg-manager.ts', './reward-manager.ts', './report-agent.ts'], function (exports) {
  var cclegacy, director, _decorator, UIManager, UIView, UIID, GameDataManager, SgManager, RewardManager, ReportAgent, CustomReportEvent;
  return {
    setters: [function (module) {
      cclegacy = module.cclegacy;
      director = module.director;
    ...
    execute: function () {
      ...
      let DescriptionView = exports('DescriptionView', (_dec = ccclass('DescriptionView'), _dec(_class = class DescriptionView extends UIView {
        onOpen(fromUI, ...args) {
          ...
          GameDataManager.instance.sg.isPlayPlots = true;
          GameDataManager.instance.saveData();
          ReportAgent.reportCustomEvent(CustomReportEvent.USER_LIFECYCLE_MILESTONE, {
            action: 'life_first'
          });
...
System.register("chunks:///_virtual/paused-popup-sg.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './bridge-util.ts', './audio-manager.ts', './ui-manager.ts', './ui-view.ts', './game-constants.ts', './btn-toggle.ts', './ui-config.ts', './reward-manager.ts', './config.ts', './time-agent.ts', './game-data-manager.ts'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      ...
      cclegacy._RF.push({}, "76b78H5f9pAfYTUFJghakHG", "paused-popup-sg", undefined);
      const {
        ccclass,
        property
      } = _decorator;
      let PausedPopupSg = exports('PausedPopupSg', (_dec = ccclass('PausedPopupSg'), _dec2 = property(BtnToggle), _dec3 = property(BtnToggle), _dec4 = property(BtnToggle), _dec5 = property(Node), _dec6 = property(Node), _dec7 = property(Node), _dec8 = property(Node), _dec9 = property(Node), _dec10 = property(Node), _dec11 = property(EditBox), _dec(_class = (_class2 = class PausedPopupSg extends UIView {
        constructor(...args) {
          super(...args);
          _initializerDefineProperty(this, "btnMusic", _descriptor, this);
          _initializerDefineProperty(this, "btnSoundEffect", _descriptor2, this);
          _initializerDefineProperty(this, "btnVibration", _descriptor3, this);
          _initializerDefineProperty(this, "btnRestart", _descriptor4, this);
          _initializerDefineProperty(this, "btnHome", _descriptor5, this);
          _initializerDefineProperty(this, "btnContact", _descriptor6, this);
          _initializerDefineProperty(this, "version", _descriptor7, this);
          _initializerDefineProperty(this, "privacy", _descriptor8, this);
          _initializerDefineProperty(this, "inputNode", _descriptor9, this);
          _initializerDefineProperty(this, "editNode", _descriptor10, this);
          this.clickTimes = 0;
        }
        onOpen(fromUI, ...args) {
          switch (fromUI) {
            case UIID.HomeViewSg:
            case UIID.HomeView:
              this.btnHome.active = true;
              this.btnRestart.active = true;
              this.btnContact.active = false;
              this.version.active = false;
              this.privacy.active = false;
              break;
            case UIID.StartView:
            case UIID.StartViewSg:
              this.btnHome.active = false;
              this.btnRestart.active = false;
              this.btnContact.active = true;
              this.version.active = true;
              let lblVersion = this.version.getComponent(Label);
              if (lblVersion) {
                lblVersion.string = Config.GAME_VERSION;
              }
              this.privacy.active = true;
              break;
          }
          this.btnMusic.selected = AudioManager.instance.switchMusic;
          this.btnSoundEffect.selected = AudioManager.instance.switchEffect;
          this.btnVibration.selected = AudioManager.instance.switchVibration;
        }
        onCloseBtn() {
          this.onClickBtn();
          UIManager.instance.close(this);
        ...
        onMusicBtn() {
          ...
          this.btnMusic.selected = audioMgr.switchMusic;
        }
        onSoundEffectBtn() {
          let audioMgr = AudioManager.instance;
          this.onClickBtn();
          audioMgr.switchEffect = !audioMgr.switchEffect;
          this.btnSoundEffect.selected = audioMgr.switchEffect;
        }
        onVibrationBtn() {
          let audioMgr = AudioManager.instance;
          this.onClickBtn();
          audioMgr.switchVibration = !audioMgr.switchVibration;
          this.btnVibration.selected = audioMgr.switchVibration;
        }
        onRestartBtn() {
          this.onClickBtn();
          UIManager.instance.close(this);
        ...
        onGmBtn() {
          ...
          this.scheduleOnce(this.cleanClickTimes.bind(this), 3);
          // }
        }

        onConfirm() {
          let config = RewardManager.instance.getConfig();
          let signal = config.gm.signal + "";
          if (signal == this.editNode.string) {
            UIManager.instance.open(UIID.GmView);
          }
        }
        cleanClickTimes() {
      ...
      }), _descriptor2 = _applyDecoratedDescriptor(_class2.prototype, "btnSoundEffect", [_dec3], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
      ...
      }), _descriptor4 = _applyDecoratedDescriptor(_class2.prototype, "btnRestart", [_dec5], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
      ...
      }), _descriptor6 = _applyDecoratedDescriptor(_class2.prototype, "btnContact", [_dec7], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
      ...
      }), _descriptor7 = _applyDecoratedDescriptor(_class2.prototype, "version", [_dec8], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
      ...
      }), _descriptor8 = _applyDecoratedDescriptor(_class2.prototype, "privacy", [_dec9], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
      ...
      }), _descriptor9 = _applyDecoratedDescriptor(_class2.prototype, "inputNode", [_dec10], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
      ...
      }), _descriptor10 = _applyDecoratedDescriptor(_class2.prototype, "editNode", [_dec11], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
    ...
    execute: function () {
      ...
      let PictureObtainPopup = exports('PictureObtainPopup', (_dec = ccclass('PictureObtainPopup'), _dec2 = property(Boolean), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Label), _dec6 = property(Sprite), _dec7 = property(Sprite), _dec8 = property(Node), _dec9 = property(Sprite), _dec10 = property(Node), _dec11 = property(Node), _dec12 = property(Sprite), _dec13 = property(Node), _dec14 = property({
        ...
        async onOpen(fromUI, ...args) {
          ...
          this.isCloseDirectly = data.isCloseDirectly;
          if (this.isPopup) {
            if (GameDataManager.instance.data.firstGameAction.pic_obtain_popup) {
              GameDataManager.instance.data.firstGameAction.pic_obtain_popup = false;
              ReportAgent.reportCustomEvent(CustomReportEvent.USER_LIFECYCLE_MILESTONE, {
                action: 'level_win_first'
              });
            }
            AudioManager.instance.playEffect(AudioUrl.SHOW_LEVEL_WIN);
          } else {
            if (GameDataManager.instance.data.firstGameAction.select_pic_guide) {
              ReportAgent.reportCustomEvent(CustomReportEvent.USER_LIFECYCLE_MILESTONE, {
          ...
          let cost = RewardManager.instance.getConfig().sg.illustration_cost;
          if (cost > 0) {
        ...
        updateUI() {
          ...
          this.btnContinue.active = !this.isCloseDirectly && !GameDataManager.instance.data.firstGameAction.select_pic_guide;
        }
        playMagnifierAnim() {
        ...
        set isLocked(val) {
          ...
          this.lblDesc.node.parent.active = !GameDataManager.instance.data.firstGameAction.select_pic_guide && val;
        }
        onLikeBtn() {
          this.onClickBtn();
          let gdMgr = GameDataManager.instance;
        ...
        onContinueBtn() {
          ...
          if (this.isPopup) {
            ...
            console.log(`config: ${config}`);
            if (config) {
              let info = config.ad.inter.page.level_win;
              console.log(`info: ${JSON.stringify(info)}`);
              GameDataManager.instance.data.interAdWeight += info.weight;
              isOpenInter = info.is_play;
            }
            console.log(`isOpenInter: ${isOpenInter}`);
            if (isOpenInter) {
              AdManager.instance.openInterstitialAd('level_win', null);
            }
          }
          if (scene.name === 'stage-sg') {
            RewardManager.instance.openPictureSelectView();
          }
        }
        onUnlockBtn() {
        ...
        onDownloadBtn() {
          ...
          let gdMgr = GameDataManager.instance;
          let idx = gdMgr.sg.downloadedPicInfoList.findIndex(item => item.id === this.picInfo.id);
          if (idx !== -1) {
            this.saveImage();
          } else {
        ...
        saveImage() {
          if (this.sprPicCover.node.active) {
            ...
            let taskInfo = new LoadingTaskReportInfo(this.picInfo.id, LoadingTaskType.DOWNLOAD, LoadingTaskState.START, Date.now(), 0, GameDataManager.instance.data.level);
          ...
          let idx = gdMgr.sg.downloadedPicInfoList.findIndex(item => item.id === this.picInfo.id);
          if (idx == -1) {
            gdMgr.sg.downloadedPicInfoList.push(this.picInfo);
          }
        }
        onReturnBtn() {
          this.onClickBtn();
...
System.register("chunks:///_virtual/picture-select-view.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ui-view.ts', './picture-select-item.ts', './game-data-manager.ts', './reward-manager.ts', './log-util.ts', './sg-manager.ts', './ui-manager.ts', './sg-type-define.ts', './ad-manager.ts', './report-agent.ts', './ui-config.ts', './graph-manager.ts', './audio-manager.ts', './game-constants.ts', './bridge-util.ts'], function (exports) {
  var _applyDecoratedDescriptor, _initializerDefineProperty, cclegacy, Node, _decorator, director, tween, UIView, PictureSelectItem, GameDataManager, RewardManager, LogUtil, SgManager, UIManager, PictureType, AdManager, ReportAgent, CustomReportEvent, PhotoChooseNumReportEvent, PageName, BtnName, UIID, GraphManager, AudioManager, AudioUrl, BridgeUtil, VibrationEffect;
  return {
    setters: [function (module) {
      _applyDecoratedDescriptor = module.applyDecoratedDescriptor;
      _initializerDefineProperty = module.initializerDefineProperty;
    ...
    execute: function () {
      ...
      let PictureSelectView = exports('PictureSelectView', (_dec = ccclass('PictureSelectView'), _dec2 = property([PictureSelectItem]), _dec3 = property(Node), _dec(_class = (_class2 = class PictureSelectView extends UIView {
          ...
          if (Array.isArray(data.infoList) && data.infoList.length > 0) {
            this.items.forEach((item, index) => {
              ...
              if (info) {
                ...
                let showFreshBtn = list.length > 0 ? RewardManager.instance.getConfig().sg.select.refresh_time > 0 : false;
                if (showFreshBtn) {
                  isFreshShow = true;
                }
        ...
        async onFreshBtn(event, data) {
          ...
          if (++this.freshCount >= RewardManager.instance.getConfig().sg.select.refresh_time) {
            this.hideFreshBtn();
          }
        }
        hideFreshBtn() {
        ...
        onClickItem(event, data) {
          ...
          this.stopTips();
          let gdMgr = GameDataManager.instance;
          if (gdMgr.data.firstGameAction.select_pic_guide) {
            ReportAgent.reportCustomEvent(CustomReportEvent.USER_LIFECYCLE_MILESTONE, {
              action: 'pick_photo_guide'
            });
          } else if (gdMgr.data.firstGameAction.select_pic) {
            gdMgr.data.firstGameAction.select_pic = false;
            ReportAgent.reportCustomEvent(CustomReportEvent.USER_LIFECYCLE_MILESTONE, {
          ...
          if (item && item.info) {
            if (item.info.isAd) {
              ...
              console.log(`config: ${config}`);
              if (config) {
                let info = config.ad.inter.page.photo_choose;
                console.log(`info: ${JSON.stringify(info)}`);
                GameDataManager.instance.data.interAdWeight += info.weight;
                isOpenInter = info.is_play;
              }
              console.log(`isOpenInter: ${isOpenInter}`);
              if (isOpenInter) {
                AdManager.instance.openInterstitialAd('photo_choose', null);
              }
            }
          } else {
            if (director.getScene().name === 'map-sg') {
              UIManager.instance.closeAll();
              director.loadScene('stage-sg');
            } else {
              UIManager.instance.close(this);
            }
          }
        ...
        async onSelectSuccess(info) {
          ...
          gdMgr.data.selectedSgPicture = info;
          if (info.isAd) {
            let idx = gdMgr.sg.unselectedSpecialPicInfoList.findIndex(item => item.id === info.id);
            if (idx !== -1) {
              gdMgr.sg.unselectedSpecialPicInfoList.splice(idx, 1);
            }
          } else {
            let idx = gdMgr.sg.unselectedNormalPicInfoList.findIndex(item => item.id === info.id);
            if (idx !== -1) {
              gdMgr.sg.unselectedNormalPicInfoList.splice(idx, 1);
            }
          }
          let idx = gdMgr.sg.selectedPicInfoList.findIndex(item => item.id === info.id);
          if (idx == -1) {
            gdMgr.sg.selectedPicInfoList.push(info);
          }
          if (director.getScene().name === 'map-sg') {
            if (gdMgr.data.firstGameAction.select_pic_guide) {
              UIManager.instance.close(this);
...
System.register("chunks:///_virtual/sg-manager.ts", ['cc', './mount-point.ts', './ui-config.ts', './mount-manager.ts', './log-util.ts', './request-manager.ts', './storage-manager.ts', './sg-type-define.ts', './game-data-type-define.ts', './data-agent.ts', './object-util.ts', './graph-manager.ts', './game-data-manager.ts', './config.ts', './loading-manager.ts', './report-agent.ts'], function (exports) {
            ...
            case MountPoint.StageInitUIConf:
              {
                ...
                data[UIID.HomeViewSg] = {
                  bundle: 'bundle-sg',
                  prefab: "prefab/HomeView"
                };
                data[UIID.VictoryPopupSg] = {
                  bundle: 'bundle-sg',
                  prefab: "prefab/VictoryPopup",
                  preventTouch: true
                };
                ...
                data[UIID.ItemObtainPopupSg] = {
                  bundle: 'bundle-sg',
                  prefab: "prefab/ItemObtainPopup",
                  preventTouch: true
                };
                ...
                data[UIID.AlbumView] = {
                  bundle: 'bundle-sg',
                  prefab: "prefab/AlbumView",
                  preventTouch: true
                };
                data[UIID.AlbumDetailView] = {
                  bundle: 'bundle-sg',
                  prefab: "prefab/AlbumDetailView",
                  preventTouch: true
                };
                data[UIID.PausedPopupSg] = {
                  bundle: 'bundle-sg',
                  prefab: "prefab/PausedPopup",
                  preventTouch: true
                };
                ...
                data[UIID.ItemGetPopupSg] = {
                  bundle: 'bundle-sg',
                  prefab: "prefab/ItemGetPopup",
                  preventTouch: true
                };
                data[UIID.LoadingSg] = {
                  bundle: 'bundle-sg',
                ...
                data[UIID.DescriptionView] = {
                  bundle: 'bundle-sg',
                  prefab: "prefab/DescriptionView",
                  preventTouch: true
                };
                data[UIID.SpecialRewardPopup] = {
                  bundle: 'bundle-sg',
                  prefab: "prefab/SpecialRewardPopup",
                  preventTouch: true
                };
                break;
              }
...
System.register("chunks:///_virtual/sg-type-define.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './object-util.ts', './game-data-type-define.ts'], function (exports) {
...
System.register("chunks:///_virtual/sign-in-popup-sg.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './task-item.ts', './enable-btn.ts', './timer-displayer.ts', './ui-view.ts', './game-data-manager.ts', './ui-manager.ts'], function (exports) {
  var _applyDecoratedDescriptor, _initializerDefineProperty, cclegacy, Label, _decorator, TaskItem, EnableBtn, TimerDisplayer, UIView, GameDataManager, UIManager;
  return {
    setters: [function (module) {
      _applyDecoratedDescriptor = module.applyDecoratedDescriptor;
      _initializerDefineProperty = module.initializerDefineProperty;
    ...
    execute: function () {
      var _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5;
      cclegacy._RF.push({}, "d344ep7oJtJUrwFvzDDSYt4", "sign-in-popup-sg", undefined);
      const {
        ccclass,
        property
      } = _decorator;
      let SignInPopupSg = exports('SignInPopupSg', (_dec = ccclass('SignInPopupSg'), _dec2 = property(Label), _dec3 = property(Label), _dec4 = property(EnableBtn), _dec5 = property([TaskItem]), _dec6 = property(TimerDisplayer), _dec(_class = (_class2 = class SignInPopupSg extends UIView {
        constructor(...args) {
          super(...args);
          _initializerDefineProperty(this, "lblRewardNum1", _descriptor, this);
          _initializerDefineProperty(this, "lblRewardNum2", _descriptor2, this);
          _initializerDefineProperty(this, "btnClaim", _descriptor3, this);
          _initializerDefineProperty(this, "taskItems", _descriptor4, this);
          _initializerDefineProperty(this, "timer", _descriptor5, this);
        }
        onOpen(fromUI, ...args) {
          let gdMgr = GameDataManager.instance;
          this.timer.totalTime = gdMgr.data.signInData.startTime;
          this.timer.startCountDown(this.timer.totalTime);
        }
        onClose() {
          GameDataManager.instance.saveData(true);
        }
        ...
        onTimeOut() {}
        onClaimBtn() {
          if (this.btnClaim.isEnable) ;else {
            UIManager.instance.showToast("Please come back tomorrow");
          }
        }
      }, (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "lblRewardNum1", [_dec2], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
      ...
      }), _descriptor2 = _applyDecoratedDescriptor(_class2.prototype, "lblRewardNum2", [_dec3], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
      ...
      }), _descriptor3 = _applyDecoratedDescriptor(_class2.prototype, "btnClaim", [_dec4], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
      ...
      }), _descriptor4 = _applyDecoratedDescriptor(_class2.prototype, "taskItems", [_dec5], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
      ...
      }), _descriptor5 = _applyDecoratedDescriptor(_class2.prototype, "timer", [_dec6], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
    ...
    execute: function () {
      ...
      let SlidePictureView = exports('SlidePictureView', (_dec = ccclass('SlidePictureView'), _dec2 = property([Node]), _dec3 = property(Node), _dec4 = property(Sprite), _dec5 = property(Sprite), _dec6 = property(ProgressBar), _dec7 = property(Mask), _dec8 = property(Mask), _dec9 = property(Node), _dec10 = property(Node), _dec11 = property(Label), _dec12 = property(Node), _dec13 = property(Sprite), _dec14 = property(Sprite), _dec15 = property(Node), _dec16 = property(Node), _dec17 = property(Node), _dec18 = property(Node), _dec19 = property(Node), _dec20 = property(Sprite), _dec21 = property({
        ...
        async onOpen(fromUI, ...args) {
          ...
          this.btnMore.active = GameDataManager.instance.data.firstGameAction.select_pic_guide && !this.isCloseDirectly;
          this.btnContinue.active = !GameDataManager.instance.data.firstGameAction.select_pic_guide && !this.isCloseDirectly;
          ...
          if (this.layers[0].active) {
            if (this.fromUI === UIID.SpecialRewardPopup) {
              ReportAgent.reportPageMonitoring(PageName.SlidePictureViewSpeical, isPageShowError, `${showSuccessNum}/2`);
            } else {
        ...
        setProgress(progress) {
          ...
          if (GameDataManager.instance.data.firstGameAction.select_pic_guide && this.fromUI != UIID.IllustrationViewSg) {
...
System.register("chunks:///_virtual/special-reward-popup.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './bridge-util.ts', './audio-manager.ts', './ui-manager.ts', './ui-view.ts', './ui-config.ts', './game-constants.ts', './game-data-manager.ts', './sg-type-define.ts', './sg-manager.ts', './report-agent.ts', './log-util.ts', './reward-manager.ts', './bg-adapter.ts', './ad-manager.ts', './graph-manager.ts'], function (exports) {
  var _applyDecoratedDescriptor, _initializerDefineProperty, cclegacy, Node, Sprite, SpriteFrame, _decorator, director, UITransform, tween, Vec3, ParticleSystem2D, BridgeUtil, VibrationEffect, AudioManager, UIManager, UIView, UIID, AudioUrl, GameDataManager, PictureType, SgManager, ReportAgent, CustomReportEvent, PageName, BtnName, PhotoChooseNumReportEvent, LogUtil, RewardManager, BgAdapter, AdManager, GraphManager;
  return {
    setters: [function (module) {
      _applyDecoratedDescriptor = module.applyDecoratedDescriptor;
      _initializerDefineProperty = module.initializerDefineProperty;
    ...
    execute: function () {
      ...
      cclegacy._RF.push({}, "04c3fTxW3BEBZaO7oNDJZYH", "special-reward-popup", undefined);
      const {
        ccclass,
        property
      } = _decorator;
      let SpecialRewardPopup = exports('SpecialRewardPopup', (_dec = ccclass('SpecialRewardPopup'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Sprite), _dec6 = property(Sprite), _dec7 = property(Node), _dec8 = property(Sprite), _dec9 = property(Sprite), _dec10 = property({
        type: [SpriteFrame]
      }), _dec11 = property(Node), _dec12 = property(Node), _dec(_class = (_class2 = class SpecialRewardPopup extends UIView {
        constructor(...args) {
          super(...args);
          _initializerDefineProperty(this, "btnReturn", _descriptor, this);
          _initializerDefineProperty(this, "btnUnlock", _descriptor2, this);
          _initializerDefineProperty(this, "pictureArea", _descriptor3, this);
          _initializerDefineProperty(this, "sprPicCover", _descriptor4, this);
          _initializerDefineProperty(this, "sprPicPrivate", _descriptor5, this);
          _initializerDefineProperty(this, "magnifier", _descriptor6, this);
          _initializerDefineProperty(this, "sprMagPrivate", _descriptor7, this);
          _initializerDefineProperty(this, "sprLike", _descriptor8, this);
          _initializerDefineProperty(this, "framesLike", _descriptor9, this);
          _initializerDefineProperty(this, "btnSwitch", _descriptor10, this);
          _initializerDefineProperty(this, "likeEffect", _descriptor11, this);
          this.wPosPic = null;
          this.picInfo = null;
        }
        async onOpen(fromUI, ...args) {
          AudioManager.instance.playEffect(AudioUrl.SPECIAL_REWARD);
          if (GameDataManager.instance.data.firstGameAction.special_reward_popup_open) {
            GameDataManager.instance.data.firstGameAction.special_reward_popup_open = false;
            ReportAgent.reportCustomEvent(CustomReportEvent.USER_LIFECYCLE_MILESTONE, {
              action: 'surprise_card'
            });
          }
          if (this.btnUnlock.active) {
            ReportAgent.reportCustomEvent(CustomReportEvent.PAGE_BUTTON_ACTION, {
              page: PageName.SpecialRewardPopup,
              btn: BtnName.Unlock,
              action: 'show'
            });
          }
          if (this.btnReturn.active) {
            ReportAgent.reportCustomEvent(CustomReportEvent.PAGE_BUTTON_ACTION, {
              page: PageName.SpecialRewardPopup,
              btn: BtnName.Close,
              action: 'show'
          ...
          if (picData) {
            ...
            LogUtil.log(`special-reward-info reset 555`);
            let idx = GameDataManager.instance.sg.selectedPicInfoList.findIndex(item => item.id === this.picInfo.id);
            if (idx == -1) {
              GameDataManager.instance.sg.selectedPicInfoList.push(this.picInfo);
            }
          }
          this.updateUI();
          this.btnUnlock.active = true;
          ...
          if (sprB) {
            ...
            ReportAgent.reportPageMonitoring(PageName.SpecialRewardPopup, false, `${showSuccessNum}/2`);
          } else {
            this.sprPicPrivate.node.active = false;
            this.sprMagPrivate.node.active = false;
            ReportAgent.reportPageMonitoring(PageName.SpecialRewardPopup, true, `${showSuccessNum}/2`);
          }
        }
        onSwitchBtn() {
          this.flipPicture();
        ...
        onClose() {
          GameDataManager.instance.saveData();
          GameDataManager.instance.specialRewardInfo = null;
          if (GameDataManager.instance.data.firstGameAction.special_reward_popup_close) {
            GameDataManager.instance.data.firstGameAction.special_reward_popup_close = false;
            ReportAgent.reportCustomEvent(CustomReportEvent.USER_LIFECYCLE_MILESTONE, {
              action: 'game_card_surprise'
            });
          }
        }
        updateUI() {
        ...
        onLikeBtn() {
          this.onClickBtn();
          let gdMgr = GameDataManager.instance;
          let picData = gdMgr.getPictureData(this.picInfo.id);
          if (picData) {
            picData.isFavorite = !picData.isFavorite;
            this.isLike = picData.isFavorite;
          } else {
        ...
        onReturnBtn() {
          ...
          console.log(`config: ${config}`);
          if (config) {
            let info = config.ad.inter.page.surprise_reward;
            console.log(`info: ${JSON.stringify(info)}`);
            GameDataManager.instance.data.interAdWeight += info.weight;
            isOpenInter = info.is_play;
          }
          console.log(`isOpenInter: ${isOpenInter}`);
          if (isOpenInter) {
            AdManager.instance.openInterstitialAd('surprise_reward', null);
          }
          UIManager.instance.close(this);
        }
        onUnlockBtn() {
          ...
          ReportAgent.reportCustomEvent(CustomReportEvent.AD_EVENT_DISTRIBUTED, {
            reward_page_click: 'special_reward'
          });
          ReportAgent.reportCustomEvent(CustomReportEvent.PHOTO_CHOOSE_NUM, {
            id: this.picInfo.tag,
            event: PhotoChooseNumReportEvent.UNLOCKED
          });
          let picInfo = this.picInfo;
          AdManager.instance.openVideoAd('special-reward', (entry, success) => {
            if (success) {
              let picData = GameDataManager.instance.getPictureData(picInfo.id, null);
              if (!picData) {
                LogUtil.warn('picture-data-not-found');
                return;
              }
      ...
      }, (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "btnReturn", [_dec2], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
      ...
      }), _descriptor2 = _applyDecoratedDescriptor(_class2.prototype, "btnUnlock", [_dec3], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
      ...
      }), _descriptor4 = _applyDecoratedDescriptor(_class2.prototype, "sprPicCover", [_dec5], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
      ...
      }), _descriptor5 = _applyDecoratedDescriptor(_class2.prototype, "sprPicPrivate", [_dec6], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
      ...
      }), _descriptor6 = _applyDecoratedDescriptor(_class2.prototype, "magnifier", [_dec7], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
      ...
      }), _descriptor7 = _applyDecoratedDescriptor(_class2.prototype, "sprMagPrivate", [_dec8], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
      ...
      }), _descriptor8 = _applyDecoratedDescriptor(_class2.prototype, "sprLike", [_dec9], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
      ...
      }), _descriptor9 = _applyDecoratedDescriptor(_class2.prototype, "framesLike", [_dec10], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
      ...
      }), _descriptor10 = _applyDecoratedDescriptor(_class2.prototype, "btnSwitch", [_dec11], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
      ...
      }), _descriptor11 = _applyDecoratedDescriptor(_class2.prototype, "likeEffect", [_dec12], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
...
System.register("chunks:///_virtual/start-view-sg.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './bridge-util.ts', './audio-manager.ts', './ui-manager.ts', './ui-view.ts', './ui-config.ts', './game-constants.ts', './game-data-manager.ts', './reward-manager.ts', './mount-manager.ts', './mount-point.ts', './config.ts'], function (exports) {
  var _applyDecoratedDescriptor, _initializerDefineProperty, cclegacy, Label, Node, _decorator, UIOpacity, tween, Vec3, director, BridgeUtil, VibrationEffect, AudioManager, UIManager, UIView, UIID, AudioUrl, GameDataManager, RewardManager, MountManager, MountPoint, Config;
  return {
    setters: [function (module) {
      _applyDecoratedDescriptor = module.applyDecoratedDescriptor;
      _initializerDefineProperty = module.initializerDefineProperty;
    ...
    execute: function () {
      ...
      let StartViewSg = exports('StartViewSg', (_dec = ccclass('StartViewSg'), _dec2 = property(Label), _dec3 = property(Node), _dec4 = property(Node), _dec(_class = (_class2 = class StartViewSg extends UIView {
        constructor(...args) {
          super(...args);
          _initializerDefineProperty(this, "lblLevel", _descriptor, this);
          _initializerDefineProperty(this, "coverPlay", _descriptor2, this);
          _initializerDefineProperty(this, "albumBtn", _descriptor3, this);
          this.clickTimes = 0;
        }
        onOpen(fromUI, ...args) {
          this.lblLevel.string = `level : ${GameDataManager.instance.data.level}`;
          let uiOpacity = this.coverPlay.getComponent(UIOpacity);
          tween(this.coverPlay).stop();
          tween(this.coverPlay).parallel(tween().to(0.7, {
            scale: new Vec3(1.5, 1.5, 1.5)
          }), tween(uiOpacity).to(0.7, {
            opacity: 0
          })).call(() => {
            this.coverPlay.scale = new Vec3(1, 1, 1);
            this.coverPlay.getComponent(UIOpacity).opacity = 255;
        ...
        async onAlbumBtn() {
          ...
          // await SgManager.instance.preloadSpriteFrame(true);
          uiMgr.open(UIID.AlbumView);
        }
        onIllustrationBtn() {
          this.onClickBtn();
        ...
        async onPlayBtn() {
          let selectedPic = GameDataManager.instance.data.selectedSgPicture;
          if (selectedPic) {
            let data = GameDataManager.instance.sg.illustration[selectedPic.id];
            if (data && data.isOwned) {
              selectedPic = GameDataManager.instance.data.selectedSgPicture = null;
            }
          }
          if (!selectedPic) {
            // 预加载没完成，继续加载
      ...
      }), _descriptor2 = _applyDecoratedDescriptor(_class2.prototype, "coverPlay", [_dec3], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
      ...
      }), _descriptor3 = _applyDecoratedDescriptor(_class2.prototype, "albumBtn", [_dec4], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
